...
if(MODULE_SHIPPING_ECONT_STATUS == 'True') {
	...
	include_once('../' . DIR_WS_MODULES .'shipping/econt/admin/modules_econt_apps_top.php');
	//include_once('../' . DIR_WS_MODULES .'shipping/econt/admin/modules_econt_apps_top.php');
} 
?>
...
<?php if(MODULE_SHIPPING_ECONT_STATUS == 'True') { ?>
	<?php include_once('../' . DIR_WS_MODULES .'shipping/econt/admin/modules_popup_shop_config.php'); ?>
<?php } ?>
<!-- Econt Shipping Module EOF //-->
