...
*/
?>
<link rel="stylesheet" type="text/css" href="<?php echo HTTP_SERVER . DIR_WS_CATALOG; ?>includes/modules/shipping/econt/javascript/jquery/jquery.ui.all.css" />
<script language="javascript" src="<?php echo HTTP_SERVER . DIR_WS_CATALOG; ?>includes/modules/shipping/econt/javascript/jquery/jquery-1.4.3.js"></script>
<script language="javascript" src="<?php echo HTTP_SERVER . DIR_WS_CATALOG; ?>includes/modules/shipping/econt/javascript/jquery/jquery-ui-1.8.6.custom.min.js"></script>
<script language="javascript" src="<?php echo HTTP_SERVER . DIR_WS_CATALOG; ?>includes/modules/shipping/econt/javascript/jquery/jquery.bgiframe-2.1.2.js"></script>
<script language="javascript" src="<?php echo HTTP_SERVER . DIR_WS_CATALOG; ?>includes/modules/shipping/econt/javascript/jquery/ui/jquery.ui.core.js"></script>
<script language="javascript" src="<?php echo HTTP_SERVER . DIR_WS_CATALOG; ?>includes/modules/shipping/econt/javascript/jquery/ui/jquery.ui.widget.js"></script>
<script language="javascript" src="<?php echo HTTP_SERVER . DIR_WS_CATALOG; ?>includes/modules/shipping/econt/javascript/jquery/ui/jquery.ui.position.js"></script>
<script language="javascript" src="<?php echo HTTP_SERVER . DIR_WS_CATALOG; ?>includes/modules/shipping/econt/javascript/jquery/ui/jquery.ui.mouse.js"></script>
<script language="javascript" src="<?php echo HTTP_SERVER . DIR_WS_CATALOG; ?>includes/modules/shipping/econt/javascript/jquery/ui/jquery.ui.button.js"></script>
<script language="javascript" src="<?php echo HTTP_SERVER . DIR_WS_CATALOG; ?>includes/modules/shipping/econt/javascript/jquery/ui/jquery.ui.draggable.js"></script>
<script language="javascript" src="<?php echo HTTP_SERVER . DIR_WS_CATALOG; ?>includes/modules/shipping/econt/javascript/jquery/ui/jquery.ui.resizable.js"></script>
<script language="javascript" src="<?php echo HTTP_SERVER . DIR_WS_CATALOG; ?>includes/modules/shipping/econt/javascript/jquery/ui/jquery.ui.dialog.js"></script>
<script language="javascript" src="<?php echo HTTP_SERVER . DIR_WS_CATALOG; ?>includes/modules/shipping/econt/javascript/jquery/ui/jquery.effects.core.js"></script>
