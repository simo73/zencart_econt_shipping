 ...
 */
 ...
 /** Econt Shipping Module BOF **/
        if (($_SESSION['shipping']['id'] == 'econt_OFFICE_DOOR') or ($_SESSION['shipping']['id'] == 'econt_DOOR_DOOR') ) {
          $order->info['shipping_method'] = MODULE_SHIPPING_ECONT_CHECKOUTSHIPPING_METHOD_NAME_DOOR_DOOR_TEXT;
         }
